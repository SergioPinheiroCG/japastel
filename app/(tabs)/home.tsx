...
const produtos = [
  ...
  { id: '5', nome: 'Refrigerantes', descricao: 'Melão, Mirtilo, Morango, Original, Laranja', preco: 'R$ 5,00', imagem: require('../../assets/images/refrigerante.png') },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bannerContainer}>
        <Text style={styles.bannerText}>ENTREGA GRÁTIS PARA TODA A CIDADE</Text>
      </View>
